...
- ✅ **iOS & iPadOS shell (Milestone 6):** an adaptive `NavigationSplitView` — two columns (list + editor) on iPad, collapsing to a push stack on iPhone — sharing the Core/State layers (browse/read/edit companion).
